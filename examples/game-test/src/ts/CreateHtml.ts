import { CreateButton, CreateImgButton } from "../../../../src/ts/gamelib/Elements/Button";
import { Canvas } from "../../../../src/ts/gamelib/Elements/Canvas";
import { Assets } from "./assets";

export function CreateTestHtml(document: Document): Canvas {
    let b1:HTMLButtonElement = document.getElementById("div1").appendChild(CreateImgButton(document, Assets.assets.nextButton.img.src));
