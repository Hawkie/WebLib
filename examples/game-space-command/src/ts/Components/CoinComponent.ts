import { ISprite, HorizontalSpriteSheet } from "../../../../../src/ts/gamelib/DataTypes/Sprite";
import { IAnimator, UpdateAnimator, UpdateSprite } from "../../../../../src/ts/gamelib/Actors/SpriteAnimator";
import { DrawContext } from "../../../../../src/ts/gamelib/Views/DrawContext";
import { DrawSpriteAngled } from "../../../../../src/ts/gamelib/Views/Sprites/SpriteAngledView";
...
export function DisplayCoin(ctx: DrawContext, coin: ICoin): void {
    DrawSpriteAngled(ctx, coin.x, coin.y, coin.angle, coin.sprite, AsteroidAssets.assets.coinSprite);
}
