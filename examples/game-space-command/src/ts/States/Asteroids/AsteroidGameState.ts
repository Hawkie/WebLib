...
export function InputAsteroidsGameState(state: IAsteroidsGameState, eState: IEventState): IAsteroidsGameState {
    return {...state,
        asteroidsState: InputAsteroidsState(state.asteroidsState, eState)
    };
}
